...
async function main() {
  ...
  await prisma.permit.createMany({
    data: [
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0001',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0002',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0003',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0004',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0005',
        riskType: 'ALTURA', status: 'APPROVED',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0006',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0007',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0008',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0009',
        riskType: 'ALTURA', status: 'APPROVED',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0010',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0011',
        riskType: 'CONFINADO', status: 'APPROVED',
      ...
      {
        companyId: companyB.id, permitNumber: 'SIC-2025-0012',
  ...
  await prisma.auditLog.createMany({
    data: [
      ...
      { companyId: companyB.id, userId: supervisorB.id, action: 'APPROVE', entityType: 'PERMIT', entityId: 'SIC-2025-0001', details: JSON.stringify({ permitNumber: 'SIC-2025-0001', riskType: 'ALTURA' }) },
      { companyId: companyB.id, userId: adminB.id, action: 'REJECT', entityType: 'PERMIT', entityId: 'SIC-2025-0004', details: JSON.stringify({ permitNumber: 'SIC-2025-0004', reason: 'Zona caliente no despejada' }) },
      { companyId: companyB.id, userId: supervisorB.id, action: 'APPROVE', entityType: 'PERMIT', entityId: 'SIC-2025-0003', details: JSON.stringify({ permitNumber: 'SIC-2025-0003', riskType: 'CONFINADO' }) },
      { companyId: companyB.id, userId: adminB.id, action: 'REJECT', entityType: 'PERMIT', entityId: 'SIC-2025-0012', details: JSON.stringify({ permitNumber: 'SIC-2025-0012', reason: 'EPP dieléctrico no disponible' }) },
      { companyId: companyB.id, userId: techB1.id, action: 'CREATE', entityType: 'PERMIT', entityId: 'SIC-2025-0001', details: JSON.stringify({ permitNumber: 'SIC-2025-0001', riskType: 'ALTURA' }) },
      { companyId: companyB.id, userId: techB2.id, action: 'CREATE', entityType: 'PERMIT', entityId: 'SIC-2025-0002', details: JSON.stringify({ permitNumber: 'SIC-2025-0002', riskType: 'ELECTRICO' }) },
